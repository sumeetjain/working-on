RSpec.describe(Post, '#format_post_front_page') do
	it("takes an array of seql row strings and formats them for front page display") do
	    # Setup
...
# 	it("takes an array of seql row strings and formats them for admin page display") do
# 	    # Setup
# 	    row = ["07/08/88,1488668340,02:24:33,Ben,1,What is this dude talking about?"]	
# 	    # Exercise
